 ...
 */
            ...
            /**
            *  CheckRedemptionCodeResp bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckRedemptionCodeResp extends com.cmt.vending.ws.obj.xsd.WsResp
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CheckRedemptionCodeResp
                ...
                */
                        ...
                        /**
                        * field for RedemptionInfo
                        */

                        
                                    protected com.cmt.vending.ws.obj.xsd.RedemptionInfo localRedemptionInfo ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRedemptionInfoTracker = false ;

                           public boolean isRedemptionInfoSpecified(){
                               return localRedemptionInfoTracker;
                           }
                           ...
                           * @return com.cmt.vending.ws.obj.xsd.RedemptionInfo
                           */
                           public  com.cmt.vending.ws.obj.xsd.RedemptionInfo getRedemptionInfo(){
                               return localRedemptionInfo;
                           }
                            ...
                            /**
                               ...
                               * @param param RedemptionInfo
                               */
                               public void setRedemptionInfo(com.cmt.vending.ws.obj.xsd.RedemptionInfo param){
                            localRedemptionInfoTracker = true;
                                   
                                            this.localRedemptionInfo=param;
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CheckRedemptionCodeResp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CheckRedemptionCodeResp",
                           xmlWriter);
                   }
                ...
                if (localErrorCodeTracker){
                             ...
                             if (localVideoList!=null) {
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRedemptionInfoTracker){
                                    if (localRedemptionInfo==null){

                                        writeStartElement(null, "http://obj.ws.vending.cmt.com/xsd", "redemptionInfo", xmlWriter);

                                       // write the nil attribute
                                      writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","nil","1",xmlWriter);
                                      xmlWriter.writeEndElement();
                                    }else{
                                     localRedemptionInfo.serialize(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","redemptionInfo"),
                                        xmlWriter);
                                    }
                                }
                    xmlWriter.writeEndElement();
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","CheckRedemptionCodeResp"));
                 if (localErrorCodeTracker){
                            ...
                            elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                    ...
                                    elementList.add(localRedemptionInfo==null?null:
                                    localRedemptionInfo);
                                }
    ...
    public static class Factory{
        ...
        */
        public static CheckRedemptionCodeResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckRedemptionCodeResp object =
                new CheckRedemptionCodeResp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckRedemptionCodeResp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CheckRedemptionCodeResp)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list8 = new java.util.ArrayList();
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list5.add(com.cmt.vending.ws.obj.xsd.RFIDInfo.Factory.parse(reader));
                                                                }
                                    ...
                                    // Process the array and step past its final element's end.
                                              ...
                                              nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                              if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                                  list8.add(String.valueOf(java.lang.Integer.MIN_VALUE));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","redemptionInfo").equals(reader.getName())){
                                
                                      nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                      if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                          object.setRedemptionInfo(null);
                                          reader.next();
                                            ...
                                            reader.next();
                                                ...
                                                object.setRedemptionInfo(com.cmt.vending.ws.obj.xsd.RedemptionInfo.Factory.parse(reader));
