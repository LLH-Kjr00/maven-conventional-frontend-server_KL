 ...
 */
            ...
            /**
            *  ReceiptResp bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ReceiptResp extends com.cmt.vending.ws.obj.xsd.WsResp
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","ReceiptResp"));
                 if (localErrorCodeTracker){
    ...
    public static class Factory{
        ...
        */
        public static ReceiptResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ReceiptResp object =
                new ReceiptResp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ReceiptResp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ReceiptResp)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
