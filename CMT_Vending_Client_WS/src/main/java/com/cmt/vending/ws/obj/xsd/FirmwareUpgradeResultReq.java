 ...
 */
            ...
            /**
            *  FirmwareUpgradeResultReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FirmwareUpgradeResultReq extends com.cmt.vending.ws.obj.xsd.WsReq
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = FirmwareUpgradeResultReq
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FirmwareUpgradeResultReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FirmwareUpgradeResultReq",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","FirmwareUpgradeResultReq"));
                 if (localCpuUsageTracker){
    ...
    public static class Factory{
        ...
        */
        public static FirmwareUpgradeResultReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FirmwareUpgradeResultReq object =
                new FirmwareUpgradeResultReq();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FirmwareUpgradeResultReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FirmwareUpgradeResultReq)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
