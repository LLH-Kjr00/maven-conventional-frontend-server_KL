 ...
 */
            ...
            /**
            *  VmRequestLogReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class VmRequestLogReq extends com.cmt.vending.ws.obj.xsd.WsReq
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = VmRequestLogReq
                ...
                */
                        ...
                        /**
                        * field for RequestLogs
                        * This was an Array!
                        */

                        
                                    protected com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[] localRequestLogs ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRequestLogsTracker = false ;

                           public boolean isRequestLogsSpecified(){
                               return localRequestLogsTracker;
                           }
                           ...
                           * @return com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[]
                           */
                           public  com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[] getRequestLogs(){
                               return localRequestLogs;
                           }
                              ...
                              /**
                               * validate the array for RequestLogs
                               */
                              protected void validateRequestLogs(com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[] param){
                              ...
                              * @param param RequestLogs
                              */
                              public void setRequestLogs(com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[] param){
                              
                                   validateRequestLogs(param);

                               localRequestLogsTracker = true;
                                      
                                      this.localRequestLogs=param;
                              }
                             ...
                             * @param param com.cmt.vending.ws.obj.xsd.VmRequestLogInfo
                             */
                             public void addRequestLogs(com.cmt.vending.ws.obj.xsd.VmRequestLogInfo param){
                                   if (localRequestLogs == null){
                                   localRequestLogs = new com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localRequestLogs);
                               list.add(param);
                               this.localRequestLogs =
                             (com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[])list.toArray(
                            new com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VmRequestLogReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VmRequestLogReq",
                ...
                if (localCpuUsageTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRequestLogsTracker){
                                       if (localRequestLogs!=null){
                                            for (int i = 0;i < localRequestLogs.length;i++){
                                                if (localRequestLogs[i] != null){
                                                 localRequestLogs[i].serialize(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","requestLogs"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://obj.ws.vending.cmt.com/xsd", "requestLogs", xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","VmRequestLogReq"));
                 if (localCpuUsageTracker){
                             ...
                             if (localRequestLogs!=null) {
                                 for (int i = 0;i < localRequestLogs.length;i++){
                                    ...
                                    if (localRequestLogs[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                                                          "requestLogs"));
                                         elementList.add(localRequestLogs[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                                                          "requestLogs"));
                                        elementList.add(localRequestLogs);
    ...
    public static class Factory{
        ...
        */
        public static VmRequestLogReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VmRequestLogReq object =
                new VmRequestLogReq();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VmRequestLogReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VmRequestLogReq)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list14 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","requestLogs").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list14.add(com.cmt.vending.ws.obj.xsd.VmRequestLogInfo.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone14){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","requestLogs").equals(reader.getName())){
                                                        ...
                                                        object.setRequestLogs((com.cmt.vending.ws.obj.xsd.VmRequestLogInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cmt.vending.ws.obj.xsd.VmRequestLogInfo.class,
                                                                list14));
