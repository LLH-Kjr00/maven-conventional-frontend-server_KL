 ...
 */
            ...
            /**
            *  VideoDownloadLogReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class VideoDownloadLogReq extends com.cmt.vending.ws.obj.xsd.WsReq
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = VideoDownloadLogReq
                ...
                */
                        ...
                        /**
                        * field for DownloadLogs
                        * This was an Array!
                        */

                        
                                    protected com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[] localDownloadLogs ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localDownloadLogsTracker = false ;

                           public boolean isDownloadLogsSpecified(){
                               return localDownloadLogsTracker;
                           }
                           ...
                           * @return com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[]
                           */
                           public  com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[] getDownloadLogs(){
                               return localDownloadLogs;
                           }
                              ...
                              /**
                               * validate the array for DownloadLogs
                               */
                              protected void validateDownloadLogs(com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[] param){
                              ...
                              * @param param DownloadLogs
                              */
                              public void setDownloadLogs(com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[] param){
                              
                                   validateDownloadLogs(param);

                               localDownloadLogsTracker = true;
                                      
                                      this.localDownloadLogs=param;
                              }
                             ...
                             * @param param com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo
                             */
                             public void addDownloadLogs(com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo param){
                                   if (localDownloadLogs == null){
                                   localDownloadLogs = new com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localDownloadLogs);
                               list.add(param);
                               this.localDownloadLogs =
                             (com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[])list.toArray(
                            new com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":VideoDownloadLogReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "VideoDownloadLogReq",
                ...
                if (localCpuUsageTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localDownloadLogsTracker){
                                       if (localDownloadLogs!=null){
                                            for (int i = 0;i < localDownloadLogs.length;i++){
                                                if (localDownloadLogs[i] != null){
                                                 localDownloadLogs[i].serialize(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","downloadLogs"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://obj.ws.vending.cmt.com/xsd", "downloadLogs", xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","VideoDownloadLogReq"));
                 if (localCpuUsageTracker){
                             ...
                             if (localDownloadLogs!=null) {
                                 for (int i = 0;i < localDownloadLogs.length;i++){
                                    ...
                                    if (localDownloadLogs[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                                                          "downloadLogs"));
                                         elementList.add(localDownloadLogs[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                                                          "downloadLogs"));
                                        elementList.add(localDownloadLogs);
    ...
    public static class Factory{
        ...
        */
        public static VideoDownloadLogReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            VideoDownloadLogReq object =
                new VideoDownloadLogReq();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"VideoDownloadLogReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (VideoDownloadLogReq)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list14 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","downloadLogs").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list14.add(com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone14){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","downloadLogs").equals(reader.getName())){
                                                        ...
                                                        object.setDownloadLogs((com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cmt.vending.ws.obj.xsd.VideoDownloadLogInfo.class,
                                                                list14));
