...
/**
 * FirmwareUpgradeResultResp.java
 *
 ...
 */
            ...
            /**
            *  FirmwareUpgradeResultResp bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class FirmwareUpgradeResultResp extends com.cmt.vending.ws.obj.xsd.WsResp
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = FirmwareUpgradeResultResp
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":FirmwareUpgradeResultResp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "FirmwareUpgradeResultResp",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","FirmwareUpgradeResultResp"));
                 if (localErrorCodeTracker){
    ...
    public static class Factory{
        ...
        */
        public static FirmwareUpgradeResultResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            FirmwareUpgradeResultResp object =
                new FirmwareUpgradeResultResp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"FirmwareUpgradeResultResp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (FirmwareUpgradeResultResp)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
