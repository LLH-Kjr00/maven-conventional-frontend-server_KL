 ...
 */
            ...
            /**
            *  DownloadOctMetaFileReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DownloadOctMetaFileReq extends com.cmt.vending.ws.obj.xsd.WsReq
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DownloadOctMetaFileReq
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DownloadOctMetaFileReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DownloadOctMetaFileReq",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","DownloadOctMetaFileReq"));
                 if (localCpuUsageTracker){
    ...
    public static class Factory{
        ...
        */
        public static DownloadOctMetaFileReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DownloadOctMetaFileReq object =
                new DownloadOctMetaFileReq();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DownloadOctMetaFileReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DownloadOctMetaFileReq)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
