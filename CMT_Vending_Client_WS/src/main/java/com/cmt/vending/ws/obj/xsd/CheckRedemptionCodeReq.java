 ...
 */
            ...
            /**
            *  CheckRedemptionCodeReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckRedemptionCodeReq extends com.cmt.vending.ws.obj.xsd.WsReq
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = CheckRedemptionCodeReq
                ...
                */
                        ...
                        /**
                        * field for RedemptionCode
                        */

                        
                                    protected java.lang.String localRedemptionCode ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localRedemptionCodeTracker = false ;

                           public boolean isRedemptionCodeSpecified(){
                               return localRedemptionCodeTracker;
                           }
                           ...
                           */
                           public  java.lang.String getRedemptionCode(){
                            ...
                            /**
                               ...
                               * @param param RedemptionCode
                               */
                               public void setRedemptionCode(java.lang.String param){
                            localRedemptionCodeTracker = true;
                                   
                                            this.localRedemptionCode=param;
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":CheckRedemptionCodeReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "CheckRedemptionCodeReq",
                           xmlWriter);
                   }
                ...
                if (localCpuUsageTracker){
                                   ...
                                   xmlWriter.writeEndElement();
                             } if (localRedemptionCodeTracker){
                                    namespace = "http://obj.ws.vending.cmt.com/xsd";
                                    writeStartElement(null, namespace, "redemptionCode", xmlWriter);
                             

                                          if (localRedemptionCode==null){
                                              // write the nil attribute
                                                   ...
                                                   xmlWriter.writeCharacters(localRedemptionCode);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","CheckRedemptionCodeReq"));
                 if (localCpuUsageTracker){
                                ...
                                elementList.add(
                                   org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localVmVersionMs));
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                         ...
                                         elementList.add(localRedemptionCode==null?null:
                                         org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localRedemptionCode));
                                    }
    ...
    public static class Factory{
        ...
        */
        public static CheckRedemptionCodeReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CheckRedemptionCodeReq object =
                new CheckRedemptionCodeReq();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"CheckRedemptionCodeReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CheckRedemptionCodeReq)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","redemptionCode").equals(reader.getName())){
