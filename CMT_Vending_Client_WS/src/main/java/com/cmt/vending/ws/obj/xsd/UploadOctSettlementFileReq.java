...
/**
 * UploadOctSettlementFileReq.java
 *
 ...
 */
            ...
            /**
            *  UploadOctSettlementFileReq bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class UploadOctSettlementFileReq extends com.cmt.vending.ws.obj.xsd.UploadFileReq
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = UploadOctSettlementFileReq
                ...
                */
                        ...
                        /**
                        * field for SettlementFiles
                        * This was an Array!
                        */

                        
                                    protected com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[] localSettlementFiles ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localSettlementFilesTracker = false ;

                           public boolean isSettlementFilesSpecified(){
                               return localSettlementFilesTracker;
                           }
                           ...
                           * @return com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[]
                           */
                           public  com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[] getSettlementFiles(){
                               return localSettlementFiles;
                           }
                              ...
                              /**
                               * validate the array for SettlementFiles
                               */
                              protected void validateSettlementFiles(com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[] param){
                              ...
                              * @param param SettlementFiles
                              */
                              public void setSettlementFiles(com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[] param){
                              
                                   validateSettlementFiles(param);

                               localSettlementFilesTracker = true;
                                      
                                      this.localSettlementFiles=param;
                              }
                             ...
                             * @param param com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo
                             */
                             public void addSettlementFiles(com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo param){
                                   if (localSettlementFiles == null){
                                   localSettlementFiles = new com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[]{};
                                   }
                               ...
                               java.util.List list =
                            org.apache.axis2.databinding.utils.ConverterUtil.toList(localSettlementFiles);
                               list.add(param);
                               this.localSettlementFiles =
                             (com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[])list.toArray(
                            new com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[list.size()]);
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":UploadOctSettlementFileReq",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "UploadOctSettlementFileReq",
                           xmlWriter);
                   }
                ...
                if (localCpuUsageTracker){
                                       ...
                                       if (localFiles!=null){
                                            for (int i = 0;i < localFiles.length;i++){
                                                if (localFiles[i] != null){
                                                 localFiles[i].serialize(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","files"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://obj.ws.vending.cmt.com/xsd", "files", xmlWriter);
                                 ...
                                 } if (localSettlementFilesTracker){
                                       if (localSettlementFiles!=null){
                                            for (int i = 0;i < localSettlementFiles.length;i++){
                                                if (localSettlementFiles[i] != null){
                                                 localSettlementFiles[i].serialize(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","settlementFiles"),
                                                           xmlWriter);
                                                } else {
                                                   
                                                            writeStartElement(null, "http://obj.ws.vending.cmt.com/xsd", "settlementFiles", xmlWriter);
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","UploadOctSettlementFileReq"));
                 if (localCpuUsageTracker){
                             ...
                             if (localSettlementFiles!=null) {
                                 for (int i = 0;i < localSettlementFiles.length;i++){
                                    ...
                                    if (localSettlementFiles[i] != null){
                                         elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                                                          "settlementFiles"));
                                         elementList.add(localSettlementFiles[i]);
                                    } else {
                                        ...
                                        elementList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd",
                                                                          "settlementFiles"));
                                        elementList.add(localSettlementFiles);
    ...
    public static class Factory{
        ...
        */
        public static UploadOctSettlementFileReq parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            UploadOctSettlementFileReq object =
                new UploadOctSettlementFileReq();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"UploadOctSettlementFileReq".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (UploadOctSettlementFileReq)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                        ...
                        java.util.ArrayList list15 = new java.util.ArrayList();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","files").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list14.add(com.cmt.vending.ws.obj.xsd.FileItem.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone14){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","files").equals(reader.getName())){
                                                        ...
                                                        object.setFiles((com.cmt.vending.ws.obj.xsd.FileItem[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cmt.vending.ws.obj.xsd.FileItem.class,
                                                                list14));
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","settlementFiles").equals(reader.getName())){
                                    ...
                                    // Process the array and step past its final element's end.
                                                        ...
                                                        list15.add(com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo.Factory.parse(reader));
                                                                }
                                                        //loop until we find a start element that is not part of this array
                                                        ...
                                                        while(!loopDone15){
                                                            ...
                                                            if (reader.isEndElement()){
                                                                ...
                                                                if (new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","settlementFiles").equals(reader.getName())){
                                                        ...
                                                        object.setSettlementFiles((com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo[])
                                                            org.apache.axis2.databinding.utils.ConverterUtil.convertToArray(
                                                                com.cmt.vending.ws.obj.xsd.OctSettlementFileInfo.class,
                                                                list15));
