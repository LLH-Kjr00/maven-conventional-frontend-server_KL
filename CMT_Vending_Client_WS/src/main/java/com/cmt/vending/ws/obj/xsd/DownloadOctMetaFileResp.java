 ...
 */
            ...
            /**
            *  DownloadOctMetaFileResp bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class DownloadOctMetaFileResp extends com.cmt.vending.ws.obj.xsd.WsResp
        implements org.apache.axis2.databinding.ADBBean{
        /* This type was generated from the piece of schema that had
                name = DownloadOctMetaFileResp
                ...
                java.lang.String namespace = null;
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":DownloadOctMetaFileResp",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "DownloadOctMetaFileResp",
                           xmlWriter);
                   }
        ...
        */
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 java.util.ArrayList attribList = new java.util.ArrayList();
                    ...
                    attribList.add(new javax.xml.namespace.QName("http://obj.ws.vending.cmt.com/xsd","DownloadOctMetaFileResp"));
                 if (localErrorCodeTracker){
    ...
    public static class Factory{
        ...
        */
        public static DownloadOctMetaFileResp parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            DownloadOctMetaFileResp object =
                new DownloadOctMetaFileResp();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"DownloadOctMetaFileResp".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (DownloadOctMetaFileResp)com.cmt.vending.ws.obj.xsd.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
